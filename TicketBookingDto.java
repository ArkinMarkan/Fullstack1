...
public class TicketBookingDto {
    ...
    @JsonAlias({"number_of_tickets"})
    private Integer numberOfTickets;
    
    // Seat numbers optional for tests; service can validate when provided
    @JsonProperty("seatNumbers")
    @JsonAlias({"seat_numbers"})
