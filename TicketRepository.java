...
public interface TicketRepository extends JpaRepository<Ticket, Long> {
    ...
    // Projection to avoid Object[] casting issues
    ...
    /**
     * Get user booking summary using interface-based projection
     */
    @Query("""
        SELECT 
            COUNT(t) as totalBookings,
        ...
        """)
    UserBookingSummary getUserBookingSummary(@Param("userId") Long userId);
